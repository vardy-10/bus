...
public interface RetrieveDao {
	public List<Retrieve> select(@Param("otherMap") Map<String, String> otherMap,
	...
	public List<Retrieve> selectRetrieve(@Param("columnMap") Map<String, String> columnMap, @Param("offset") int offset,
                                         @Param("size") int size);
	
	public List<Retrieve> selectWx();
}
