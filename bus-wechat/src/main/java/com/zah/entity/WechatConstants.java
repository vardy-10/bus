...
public class WechatConstants {
	 ...
	 */
	public static final String TOKEN = "zah";

	public static final String APPID = "wxc1bd0aa0b40168b5";

	public static final String APPSECRET = "3d99f2ee710eb744fc9a293bd94dcd96";

	/**
	 * EncodingAESKey 公众平台上面自己填写的43位EncodingAESKey(服务号的)
	 */
	// public static final String EncodingAESKey =
	// "bcW2S8ZsB19kbCTMmHtKi82ZYyNQmA5MRTFWwEj8Gwv";
	public static final String EncodingAESKey = "OsGtDwVjAS5BH9RddgM1TtxZ4SHAsx25YjloHIAVEQu";
	/**
	 ...
	 * code获取授权信息
	 */
	public static final String AUTH_INFO = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=APPID&secret=SECRET&code=CODE&grant_type=authorization_code";
}
